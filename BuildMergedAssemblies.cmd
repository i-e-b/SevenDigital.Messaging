...
..\tools\ILMerge.exe /allowDup /targetplatform:"v4,c:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.0" /out:..\merged\SevenDigital.Messaging.dll SevenDigital.Messaging.dll RabbitMQ.Client.dll StructureMap.dll SevenDigital.Messaging.Base.dll SignalHandling.dll ShiftIt.dll DiskQueue.dll
